<div>
    ...
    <div class="max-w-3xl mx-4 my-10 lg:my-12 lg:mx-auto">
        ...
        @if ($tags->count() > 0)
            ...
            <div class="flex flex-wrap my-5">
                @foreach ($tags as $tag)
                    <button type="button" class="flex items-center justify-center px-2 py-1 mb-1 mr-1 text-sm transition duration-100 bg-white border rounded hover:no-underline hover:bg-indigo-300 whitespace-nowrap" title="Apply tag filter" wire:click="toggleTagFilter({{ $tag->id }})">
                        {{ $tag->name }}
    ...
    <div class="max-w-3xl mx-4 my-10 lg:mx-auto">
